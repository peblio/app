...
const LearnMoreModal = ({ closeLearnMoreModal }) => (
  ...
  >
    <React.Fragment>
      ...
      <iframe title="intro" width="560" height="315" src="https://www.youtube.com/embed/amt6Q_F9TYg" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
