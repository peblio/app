            ...
            <main className="class-view__main">
              <div className="class-view__header-area">
                ...
                <div className="class-view__header-area__class-code ">
                  Class code :
                  {' '}
                  <div className="class-view__header-area__class-code__container">
                    <input
                      ...
                      spellCheck="false"
                    />
                    <span className="class-view__header-area__class-code__container__span">
                      {match.params.classId}
                    </span>
                    <span className={`class-view__header-area__class-code__container__copied ${
                      codeClicked ? 'active' : ''
                    }`}
                    >
                      Copied!
