    ...
    return (
      <div>
        <div className="demoNotice">
          This is a demo version of Peblio. Feel free to play around but projects will not yet be saved. <a target="_blank" href="http://www.peblio.co">Contact us</a> with feedback. We would love to hear from you!
        </div>
